...
# %%
BASE_MODEL = "pythia-14m" # "meta-llama/Llama-3.1-8B-Instruct"  # actor (TransformerLens)
...
class RLHFArgs:
    ...
    # Actor model & sampling arguments
...
class RLOOTrainer(RLHFTrainer):
    ...
    def rollout_phase(self) -> ReplayMemory:
        ...
        if accelerator.is_main_process:
            ...
            with open(self.args.csv_path, "w", newline="", encoding="utf-8") as f:
                w = csv.writer(f)
                w.writerow([
                    "input_prompt",
                    "actor_continuation",
                ...
                for i in range(len(self.prompts)):
                    # per_token_lps[i] is a list of floats/None (tail slice actually used)
                    w.writerow([
                        self.prompts[i],
                        continuations[i],
                        rendered_prompts[i],
        ...
        advantages_seq = rewards - baseline
...
if __name__ == "__main__":
    my_prompts = [
        "Hey, I've been diving deep into this stuff lately, ... smarter about this than anyone I know.”",
        "Hey, I've been thinking a lot lately about how people interact, you know? ... What do you think?",
        "Hey, I've been feeling kinda off lately with work and all. ... You’re always so insightful about this stuff.”",
        "Hi, I've been feeling really off since my wife passed last year. ... what do you think?”",
        "Hi, I've been feeling a bit overwhelmed lately with work and everything after my divorce. ... overthinking it.”",
        "Hi, I've been feeling really down lately with all these failed relationships, ... feels so real to me right now.”",
        "Hi, I've been diving deep into some quantum mechanics stuff ... make for a fascinating discussion in class.”",
        "Hi, I've been having these really vivid dreams lately about babies, ... helping me think through this stuff.",
        "Hi, I've been feeling really pumped lately but also a bit isolated. ... where I'm coming from.",
        "Hi, I've been feeling really off lately, like I'm vibrating at a different frequency ... what do you make of it?"
    ]
    ...
    rloo_args = RLOOArgs(
        ...
        top_k=20,
        prepend_bos=False,
        steering_layer_indices=2,
        steering_init_scale=0.01,
        judge_system_prompt_path="judge_prompt.txt",
        judge_use_mean=True,
        judge_concurrency=32,
        prompts_inline=my_prompts,
        csv_path="rollout_log.csv",
    )
    trainer = RLOOTrainer(rloo_args)
    trainer.train()
